package win.intheworld.opencv4androiddemo;
...
import win.intheworld.opencv4androiddemo.filter.curve.ProviaCurveFilter;
import win.intheworld.opencv4androiddemo.filter.curve.VelviaCurveFilter;
import win.intheworld.opencv4androiddemo.filter.mixer.RecolorCMVFilter;
import win.intheworld.opencv4androiddemo.filter.mixer.RecolorRCFilter;
import win.intheworld.opencv4androiddemo.filter.mixer.RecolorRGVFilter;

/**
 * Created by swliu on 2018/2/5.
...
public class CameraActivity  extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        if (numSupportedImageSizes > 1) {
            ...
            for (int i = 0; i < numSupportedImageSizes; i++) {
                ...
                sizeSubMenu.add(MENU_GROUP_ID_SIZE, i, Menu.NONE, String.format("%dx%d", size.width,
                                size.height));
            }
        }
        return true;
    ...
    private void takePhoto(final Mat rgba) {
        ...
        // Open the photo in LabActivity.activity_camera.xml
